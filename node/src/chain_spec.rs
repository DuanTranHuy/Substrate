use node_template_runtime::{
	AccountId, AuraConfig, BalancesConfig, CouncilCollectiveConfig, GenesisConfig, GrandpaConfig,
	Signature, SudoConfig, SystemConfig, TechCommitteeCollectiveConfig, WASM_BINARY,
};
